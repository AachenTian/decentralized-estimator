...
from sender_marl.model_based.types import (
    DynamicsRolloutBatch,
    DynamicsRolloutOutput,
)
...
def make_random_dynamics_collector(
    ...
    *,
    ...
    """Collect pooled-model training data with uniform random policy actions."""
    ...
    def collect(
        ...
        def one_step(carry, _):
            ...
            transition = DynamicsRolloutBatch(

...
class LocalDynamicsBatch:
    """Pooled per-agent transition batch for the shared local model.

    Collision labels are evaluation metadata only. They are not supplied to
    the dynamics network and do not alter the training objective.
    ...
    Shapes:
        ...
        agent_ids:          (B,)
        collision_flags:    (B,), bool; collision involvement at x_t
    """

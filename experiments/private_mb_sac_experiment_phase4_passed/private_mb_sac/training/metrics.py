...
OWNER_KEYS = {
    ...
    "model/generated_transitions_total",
    "model/replay_size",
    "model/mean_horizon",
    "model/max_horizon",
    ...
    "model/uncertainty_threshold_samples",
    "model/real_epistemic_mean",
    "model/real_epistemic_max",
    "model/reward_reconstruction_mae",
    "model/reward_reconstruction_max_abs",
    "model/landmark_drift_max",
    # SAC replay mixture
    "sac/skipped",
    "sac/real_batch_fraction",
    "sac/model_batch_fraction",
    # Critic
    "critic/loss",
    "critic/q1_loss",
    "critic/q2_loss",
